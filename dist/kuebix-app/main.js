...
/* harmony import */ var _ratematch_ratematch_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ratematch/ratematch.component */ "./src/app/ratematch/ratematch.component.ts");
...
/* harmony import */ var _ratematch_ratematch_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ratematch/ratematch.component */ "./src/app/ratematch/ratematch.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _ratematch_ratematch_component__WEBPACK_IMPORTED_MODULE_5__["RatematchComponent"]
            ],
            imports: [
...
/***/ "./src/app/ratematch/ratematch.component.css":
/*!***************************************************!*\
  !*** ./src/app/ratematch/ratematch.component.css ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/ratematch/ratematch.component.html":
/*!****************************************************!*\
  !*** ./src/app/ratematch/ratematch.component.html ***!
  \****************************************************/
/*! no static exports found */
...
var RatematchComponent = /** @class */ (function () {
    function RatematchComponent(dataService, fb) {
        var _this = this;
        ...
        this.dataService.getLocations().subscribe(function (data) { return _this.locations = data; }, function (err) { return console.log(err); }, function () {
            for (var _i = 0, _a = _this.locations; _i < _a.length; _i++) {
                var loc = _a[_i];
                _this.states.push("" + loc.state);
            }
            _this.states = Array.from(new Set(_this.states));
        });
        this.dataService.getMatchCrits().subscribe(function (data) { return _this.criterias = data; });
        this.createForm();
    }
    RatematchComponent.prototype.createForm = function () {
    ...
    RatematchComponent.prototype.getZips = function () {
        ...
        this.zips = this.locations.filter(function (loc) { return loc.state == currentState; }).map(function (loc) { return loc.city + "|" + loc.postal_code; });
    };
    RatematchComponent.prototype.setOrigin = function () {
        var currentZip = this.originForm.get('zip').value.split("|")[1];
        this.selectedOrigin = this.locations.find(function (x) { return x.postal_code == currentZip; });
        this.selectedDest = null;
    };
    RatematchComponent.prototype.setDest = function () {
        var currentZip = this.destForm.get('zip').value.split("|")[1];
        this.selectedDest = this.locations.find(function (x) { return x.postal_code == currentZip; });
        this.selectedOrigin = null;
    };
    ...
    RatematchComponent.prototype.genRes = function () {
        var _this = this;
        var selected = null;
        ...
        var res = this.criterias.filter(function (cri) { return cri.postal_code == selected.postal_code; }).map(function (cri) { return cri.rate_id; }).map(function (cri) { return _this.rates.filter(function (rate) { return rate.id == cri; })[0]; });
        if (this.lineItems.length > 0) {
    ...
    RatematchComponent.prototype.getPrice = function (r, q, w) {
    ...
    RatematchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./ratematch.component.html */ "./src/app/ratematch/ratematch.component.html"),
            styles: [__webpack_require__(/*! ./ratematch.component.css */ "./src/app/ratematch/ratematch.component.css")]
        }),
        __metadata("design:paramtypes", [_services_data_service__WEBPACK_IMPORTED_MODULE_1__["DataService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], RatematchComponent);
    return RatematchComponent;
}());
